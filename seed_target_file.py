...
# TESTING_DISORDER_LIST = ["Autism", "Dementia", "Depression", "ADHD", "Bipolar", "Epilepsy", "OCD", "Schizophrenia", "Tourette's", "Alzheimer's"]
...
outFile.write(DELIMITER.join(["Autism", AUTISM_REGEX + "\n"]))
...
outFile.write(DELIMITER.join(["Bipolar", BIPOLAR_REGEX + "\n"]))
...
outFile.write(DELIMITER.join(["Tourette's", TOURETTES_REGEX + "\n"]))
outFile.write(DELIMITER.join(["Alzheimer's", ALZHEIMERS_REGEX]))
outFile.close()
